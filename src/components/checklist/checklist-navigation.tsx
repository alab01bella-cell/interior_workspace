...
export function ChecklistNavigation({ currentStep, isSubmitting, totalSteps, onNext, onPrevious }: ChecklistNavigationProps) {
  ...
  return (
    <nav aria-label="체크리스트 단계 이동" className={styles.navigation}>
      ...
      <button className={styles.nextButton} disabled={isSubmitting} onClick={onNext} type={isLast ? "submit" : "button"}>
