...
export default async function ReservationsRoute(){
  ...
  return <AppShell identity={toWorkspaceIdentity(context)}><ReservationsPage initialScheduled={scheduled} received={received} todayKey={seoulDateKey(new Date())}/></AppShell>;
}
